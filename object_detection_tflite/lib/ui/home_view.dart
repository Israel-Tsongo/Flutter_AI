...
import 'package:object_detection_tflite/ui/box_widget.dart';
...
class HomeViewState extends State<HomeView> {
  ...
  void resultsCallback(List<Recognition> results) {//setter
    setState(() {
  ...
  void statsCallback(Stats stats) { //setter
    setState(() {
      this.stats = stats;
    });
  }
...
class StatsRow extends StatelessWidget {
  ...
  final String left;
  final String right;
  const StatsRow( this.left, this.right);
